...
const App = () => {
  ...
  const setVotes = async () => {
    try {
      ...
      console.log(error);
      Swal.fire('You must be connected to Rinkeby ETH testnet for this dapp to function.').then((result) => {
  ...
  return (
    <div className="mainContainer">
      ...
      <div className="space" />
        ...
        <PieChart
            data={[
            { title: 'Trump', value: totalTrump, color: '#DC3444' },
             { title: 'Biden', value: totalBiden, color: '#0C6DFD' },
        ...
        <div className="padding: 10rem">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Button variant="danger" onClick={voteTrump}>
